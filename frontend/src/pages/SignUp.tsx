    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-hero relative overflow-hidden">
        <div className="absolute inset-0">
          {/* Floating elements */}
          <div className="absolute top-20 right-20 w-32 h-32 bg-white/10 rounded-full blur-2xl medical-pulse" />
          <div className="absolute bottom-32 left-20 w-40 h-40 bg-accent/20 rounded-full blur-3xl medical-pulse" style={{ animationDelay: '1s' }} />
          <div className="absolute top-1/2 right-10 w-24 h-24 bg-mint/15 rounded-full blur-xl medical-pulse" style={{ animationDelay: '2s' }} />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center p-12 text-white">
          ...
          <h2 className="text-4xl font-bold font-heading mb-6">Join MediScan Today</h2>
          <p className="text-xl opacity-90 max-w-md">
            Start your journey to better health understanding with AI-powered insights from your medical reports.
          </p>
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              ...
              className="w-full h-12 bg-gradient-to-r from-primary to-accent text-white hover:shadow-glow transition-all duration-300 disabled:opacity-50"
            >
              {isLoading ? (
                <div className="flex items-center">
